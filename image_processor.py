...
class ImageProcessor:
    ...
    def grab_screenshot(self, region_index):
        with mss.mss() as sct:
            ...
            return region_index, white_ratio, image
    ...
    def process_images(self):
        ...
        region_index1, white_ratio1, image1 = results[0]
        region_index2, white_ratio2, image2 = results[1]
        return white_ratio1, image1, white_ratio2, image2
